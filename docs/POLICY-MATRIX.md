...
These values reproduce the features Brave currently lists as affected by Origin. Boolean values are stored as plist booleans on macOS, JSON booleans on Linux, and DWORD `0`/`1` on Windows.
