...
- macOS: Brave's managed-preferences plist and a local backup under `/Library/Application Support/MinimalBraveConfiguration`
- Windows: named Brave policy registry values and a local backup under `%ProgramData%\MinimalBraveConfiguration`
